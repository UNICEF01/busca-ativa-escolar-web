...
(function() {
    ...
    angular.module('BuscaAtivaEscolar')
        ...
        .controller('UserEditorCtrl', function($rootScope, $scope, $state, $stateParams, ngToast, Platform, Utils, Tenants, Identity, Users, Groups, StaticData, Modals) {
            ...
            $scope.changeGroup = function() {
                Modals.show(
                    ...
                    $scope.user.group.name = selectedGroup.name;
                    $scope.user.group.id = selectedGroup.id;
                }).then(function(res) {
